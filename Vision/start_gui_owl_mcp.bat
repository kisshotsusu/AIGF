...
REM 输入降采样(最长边): 1024 时 grounding prefill 比 1280 省 ~30-45%, 归一化坐标无损; 设 0 关闭
set "VISION_MAX_SIDE=1024"
REM processor 端视觉 token 像素硬上限(~2MP), 与 VISION_MAX_SIDE 双保险
set "VISION_MAX_PIXELS=2000000"
